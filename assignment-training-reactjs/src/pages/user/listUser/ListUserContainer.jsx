...
const ListUserContainer = () => {
  ...
  const rows = dataUsers?.data?.totalDocs || 0;
    ...
    <div className="mt-10">
      ...
      <Paper elevation={0} sx={{ mt: 5, width: '100%', overflow: 'hidden' }}>
        ...
        <TablePagination
          ...
          labelRowsPerPage={t('tableContainer.labelRowsPerPage')}
          labelDisplayedRows={({ from, to, count }) =>
            `${from}-${to} ${t('tableContainer.of')} ${count !== -1 ? count : '...'}`
          }
        />
      </Paper>
