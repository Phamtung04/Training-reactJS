...
export const updateSchema = yup.object().shape({
  ...
  dob: yup
    ...
    .nullable()
    .max(dayjs().subtract(1, 'day').toDate(), VALIDATE_CODES.E0007('nhỏ hơn ngày hiện tại'))
    .required(VALIDATE_CODES.E0001),
  gender: yup.string(),
  role: yup.string(),
  avatar: yup.string(),
...
export default { loginSchema, forgotSchema, registerSchema, updateSchema };
